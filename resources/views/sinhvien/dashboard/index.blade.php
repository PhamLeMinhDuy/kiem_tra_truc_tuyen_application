                ...
                <a class="col-span-1 mt-4" href="#">   
                    <div class="border border-gray-300 rounded-md shadow bg-white">
                        ...
                        <div class="text-gray-500 pb-2">
                            ...
                            <p class="mt-2 text-base font-semibold px-2">Số bài thi đã làm: <span class=" font-normal">10</span></p>
                            <p class="mt-2 text-base font-semibold px-2">Đang có: <span class="text-red-400">2 bài thi</span></p>
                        </div>
