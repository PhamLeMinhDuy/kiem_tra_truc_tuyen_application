        ...
        <form id="form-cap-nhat-giang-vien" class="mb-0">
            <div>
              <div class="form-group grid grid-cols-3 gap-4 mb-2">
                  ...
                  <input id="input-ma-giang-vien-cap-nhat" class="col-span-2 border rounded-sm px-2 py-1 input-cap-nhat-giang-vien bg-gray-300 opacity-50 cursor-not-allowed" type="text" readonly>
              </div>
              <div class="form-group grid grid-cols-3 gap-4 mb-2">
