<div class="flex items-center">
    <button class="relative inline-flex items-center justify-center overflow-hidden mb-2 me-2 " title="Tải file excel mẫu">
        <a href="{{ route('admin.quan-ly.lop-hoc-phan.download-template-lop-hoc-phan') }}" download="lop_hoc_phan_template.xlsx" class="inline-block"> 
    ...
    <button  onclick="showModalThem('{{ $modalThem }}')"  class="mr-2 border-2 border-cyan-600 py-2 px-4 rounded inline-flex items-center hover:bg-cyan-400 font-bold hover:text-white">
