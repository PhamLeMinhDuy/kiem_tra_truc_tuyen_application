...
<button  onclick="showModalThem('{{ $modalThem }}')"  class=" border-2 border-cyan-600 py-2 px-4 rounded inline-flex items-center hover:bg-cyan-400 font-bold hover:text-white">
