        ...
        <form id="form-cap-nhat-khoa">
            <div>
              <div class="form-group grid grid-cols-3 gap-4 mb-2">
                  ...
                  <input id="input-ma-khoa-cap-nhat" class="col-span-2 border rounded-sm px-2 py-1 input-cap-nhat-khoa" type="text">
              </div>
              <div class="form-group grid grid-cols-3 gap-4 mb-2">
...
<script type="text/javascript">
    ...
    $('#form-cap-nhat-khoa').on('submit', function(event){
      ...
      if (ma_khoa && ten_khoa) {
        ...
        axios.post("{{ route('admin.quan-ly.khoa.handle-cap-nhat-khoa') }}", {
            id_khoa: $('#data-id').val(),
            ma_khoa: ma_khoa,
            ten_khoa: ten_khoa,
        })
